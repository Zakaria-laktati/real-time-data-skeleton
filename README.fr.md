# Squelette de Pipeline de Données Temps Réel
...
- Tests unitaires : `pytest tests/unit` (ignorés automatiquement sur Python ≥ 3.12 car PySpark 3.4 n’est pas compatible)
